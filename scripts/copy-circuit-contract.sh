...
cp circuits/artifacts/game_js/game.wasm contracts/artifacts/circuits/board.wasm
cp circuits/artifacts/circuit_final_game.zkey contracts/artifacts/circuits/circuit_final_board.zkey